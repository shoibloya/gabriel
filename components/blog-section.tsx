...
const COMPANY_NAME = "Ink";

// Sample blog data - replace with your actual data source
const seedPosts = [
  {
    id: 1,
    title: "How to Use Your CPF for Investments in Singapore (2025 Guide)",
    excerpt: "",
    imageUrl: "/coming-soon.png?height=200&width=400",
    date: "Apr 11",
    readTime: "5 min read",
    url: "/blog-one",
    status: "pending",
  ...
  {
    id: 2,
    title: "Legacy Planning in Singapore: What Happens to Your CPF When You Pass Away?",
    excerpt: "",
    imageUrl: "/coming-soon.png?height=200&width=400",
    date: "Apr 11",
    readTime: "5 min read",
  ...
  {
    id: 3,
    title: "What to Include on a Business Card in 2025 (Singapore Edition)",
    excerpt: "",
    imageUrl: "/coming-soon.png?height=200&width=400",
    date: "Apr 18",
    readTime: "5 min read",
  ...
  {
    id: 4,
    title: "Business Card Paper Types Explained: How to Choose the Right One in Singapore",
    excerpt: "",
    imageUrl: "/coming-soon.png?height=200&width=400",
    date: "Apr 18",
    readTime: "5 min read",
